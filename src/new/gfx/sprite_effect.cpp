...
namespace Vinifera::Gfx
{
    namespace
    {
        ...
        const char PaletteSpriteHLSL[] =
            ...
            "     * 127 = neutral, 254 ~= 2x overbright, 0 = full dark. Applied\n"
            "     * to all standard shape draws so buildings / units inside an\n"
            "     * alpha-light cone brighten alongside the tiles below them.\n"
            "     * Skipped when the bucket isn't Scene (sidebar / menu sprites)\n"
            "     * because the alpha buffer is scene-relative and would leak\n"
            "     * tactical lighting / shroud through.\n"
            "     */\n"
